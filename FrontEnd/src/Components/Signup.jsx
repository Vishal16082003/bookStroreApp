    ...
    return (
        <>
            <div className="flex h-screen items-center justify-center border">
                <div className=" border sahdow-md p-5 rounded-md">
                    <div className="">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} >
                            ...
                            <div className="flex justify-around mt-4 ">
                                <button className="bg-pink-500 text-white rounded-md px-3 py-1 hover:bg-pink-700 duration-300 cursor-pointer">Signup</button>
                                <p>
                                    Have account?{" "}
                                    <button
